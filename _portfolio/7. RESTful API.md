---
title: " RESTful API"
excerpt: "The project was created with the purpose of providing a better understanding of RESTful API development. Initially, a simple todo list project was built using the SpringBoot framework. This project included a Controller class that implemented all CRUD operations (Create, Read, Update, and Delete).
...
<br/>In addition, I have designed a syllabus for this knowledge, which can be viewed by **clicking on the details**<br/>
<img src='https://github.com/han-ziqi/RESTful/raw/master/demo/CRUD%20demo.png'>"
collection: portfolio
---

## For more information, you can [check this Repository in my Github]([https://github.com/han-ziqi/MARL-RO](https://github.com/han-ziqi/RESTful)).
